    ...
    <div className="p-6 flex flex-col gap-5 min-w-[1100px]">
      ...
      <div className="grid grid-cols-12 gap-5">
        <Panel title="Incoming official sources" eyebrow="Inputs" className="col-span-12 xl:col-span-4" padded={false} bodyClassName="p-3 space-y-2">
          ...
          <p className="text-[11.5px] text-ink-4 px-1 pt-1">Sources are ranked per subject domain. A source can be authoritative for road status and merely informative for weather.</p>
        </Panel>
