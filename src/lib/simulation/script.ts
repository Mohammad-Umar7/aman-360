...
export const SCRIPT: Record<string, PersonScript> = {
  ...
  yusuf: {
    ...
    escalation: [
      { rule: "E-01", sec: 662, step: 6, outcome: "SMS unread after 5 min — automated voice call placed: no answer", channel: "voice" },
      { rule: "E-02", sec: 962, step: 7, outcome: "Second automated voice call: no answer", channel: "voice" },
      { rule: "E-03", sec: 1262, step: 7, outcome: "Welfare check requested via Tower B building management (vulnerable-persons registry)" },
...
export const TIMELINE: Ev[] = [
  ...
  [130, 1, "system", "hazard", "NCM orange alert received — convective rain 40–60 mm/h", "Valid until 16:00 for Abu Dhabi central districts."],
  ...
  [273, 3, "deterministic", "impact", "Accessibility: 2 registered profiles require accessible actions (R-06)", "One wheelchair user; one with limited mobility and a hearing impairment (text-only contact). Two profiles without a smartphone → SMS + voice."],
  [274, 3, "deterministic", "impact", "Suppressed: 3 nearby profiles outside the impact area — no alert (R-05)", "Al Majaz Business Tower, Buhaira Court, King Faisal Street traffic."],
  ...
  [401, 6, "ai", "response", "Ahmed Al Mansoori confirms safe", "\"Got it, taking King Faisal St.\" — classified safe (0.94)."],
  [415, 6, "ai", "response", "Fatima Al Zaabi confirms safe", "Arabic reply classified safe (0.94)."],
  ...
  [662, 6, "deterministic", "triage", "Yusuf Ibrahim: no read after 5 min — E-01 voice call placed, no answer", "Escalation continues per SOP."],
  ...
  [962, 7, "deterministic", "triage", "Yusuf Ibrahim: E-02 second voice call — no answer", ""],
  ...
  [1262, 7, "deterministic", "triage", "Yusuf Ibrahim: E-03 welfare check requested via Tower B building management", "Field unit if unconfirmed by 14:40."],
...
export const OPERATOR_QUEUE: Record<number, OperatorItem[]> = {
  ...
  3: [{ id: "oq-4", priority: "medium", title: "Impact set ready — 1,284 people", detail: "2 accessibility profiles, 2 without a smartphone. Review before composing.", layer: "deterministic", action: "Review" }],
