...
export const SOURCES: SourceFeed[] = [
  {
    ...
    org: "Sharjah Police Operations Room",
    kind: "police",
    authorityRank: 1,
  ...
  },
  {
    ...
    org: "Sharjah Municipality — GIS Centre",
...
export const SUBJECTS: Record<string, { label: string; labelAr: string; domain: string }> = {
  ...
  "weather:sharjah-central": { label: "Weather alert — Sharjah central", labelAr: "تنبيه الطقس — وسط الشارقة", domain: "weather" },
...
export const CLAIMS: (SourceClaim & { receivedSec: number })[] = [
  {
    ...
    value: "alert_orange",
    text: "Orange alert: convective rain 40–60 mm/h expected over Sharjah central districts until 16:00.",
    textAr: "تنبيه برتقالي: أمطار رعدية بمعدل 40–60 ملم/ساعة متوقعة على المناطق الوسطى في الشارقة حتى الساعة 16:00.",
    observedAt: "13:50:00",
    receivedAt: "14:04:10",
    receivedSec: 130,
  },
